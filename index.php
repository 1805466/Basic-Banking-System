...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #4d79ff;">
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>ANSU KUMARI</b> <br> The Sparks Foundation Project</p>
      </footer>
